---
description: 对比传统 NLP、BERT 与大语言模型的训练和使用方式，解释 LLM 为什么能够通过统一生成范式处理多种语言任务。
---
...
（这部分在 [第七章](../02-training-alignment/07-scaling-law-emergence.md) 详细展开。）
