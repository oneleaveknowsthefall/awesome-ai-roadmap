...
1. 大语言模型与传统 NLP 的本质区别
2. Transformer 架构原理
3. MHA 的局限与 MQA、GQA、Flash Attention
4. 位置编码：sin/cos、RoPE 与 ALiBi
5. Tokenizer 分词器原理
...
8. 微调方案全景
9. LoRA 技术详解
10. Post-Training：RLHF、DPO、GRPO 与拒绝采样
11. DPO 与 PPO 的区别

### 推理与生成

12. 解码策略：贪心、Beam Search 与采样
13. Temperature、Top-P 与 Top-K
14. KV Cache 与 Prompt Caching
15. 模型量化：INT8、INT4、GPTQ 与 AWQ
...
19. MoE 混合专家模型
20. 部署方案：vLLM、SGLang、TGI 与 llama.cpp
