...
> 本节只说明 Agent 如何使用协议；MCP 的生命周期、传输和安全规范详见[Tools：MCP](../../tools/02-mcp/04-what-is-mcp.md)，跨 Agent 协作协议详见[Tools：A2A](../../tools/04-agent-communication/11-a2a-protocol.md)。
