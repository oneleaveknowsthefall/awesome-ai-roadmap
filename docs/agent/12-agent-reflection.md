...
Agent Reflection 不是模型进行神秘的“自省”，而是一种反馈驱动的控制机制：
...
> **Verification 发现可证实的问题，Reflection 将问题转化为可执行改进。**
...
Self-Reflection 可以改善结果，但不能被假设为客观验证。
...
最关键的指标不是“Critic 写了多少意见”，而是：

> **反思是否以可接受成本提高最终任务成功率，并减少风险。**
...
Self-Refine、Reflexion、Critic Agent、Debate 和 LATS 都是不同深度的反馈机制。它们能够提升质量，但都会增加成本，也都不能替代真实环境、测试、权威数据和人工责任。
