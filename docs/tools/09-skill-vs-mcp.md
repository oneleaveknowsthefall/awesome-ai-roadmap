...
> **MCP 是给 Agent 配电脑，Skill 是给 Agent 发操作手册。一个是能力，一个是方法，层次完全不同。**
...
实践推论：接很多 MCP Server 时要做 [动态工具筛选](03-tool-schema-design.md)；而 Skill 可以放心地准备几十个。
...
注意第一步末尾那句「如果超过 2000 行……」——这正是 Skill 的价值所在。MCP 只提供「能拿到 diff」这个能力，**遇到大 diff 该怎么办属于流程知识**，写在 Skill 里。
...
> **一句话概括：MCP 让 Agent 有手，Skill 让 Agent 知道这双手该按什么顺序做什么，前者是能力边界，后者是方法沉淀。**
