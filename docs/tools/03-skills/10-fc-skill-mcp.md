...
这个类比的好处是它同时解释了**为什么不能互相替代**：手不能变成厨房，厨房也不能代替菜谱。
...
这是本章最核心的误区。它们是三层架构，同一个系统里通常三者同时存在。
...
这道题最好的答法是用一个具体场景把三层串起来，让人看出你理解的是系统协作，而不是三段定义。
...
> **一句话概括：Function Calling 是语言，MCP 是工具箱，Skill 是操作手册——语言让你能开口，工具箱让你有东西可用，操作手册让你知道该按什么顺序用。**
