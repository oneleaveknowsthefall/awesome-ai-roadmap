...
1. [第二十章：AutoGen 与 CrewAI 的多智能体抽象](20-autogen-and-crewai.zh.md)
2. [第二十一章：PydanticAI 的类型安全范式与三者适用边界](21-pydanticai-and-decision-matrix.zh.md)
...
- 如果正在选型、不确定用哪个，可直接看第二十一章的决策矩阵，再跳转 [框架选型与可移植架构](../06-selection-portability/README.zh.md) 看跨全部框架的统一对照。
